---
title: Settings & UI Skill
description: Open the companyFILES web UI, view settings, and get help on available tools.
---

Use this skill when asked to browse files, open the file manager, manage templates, change settings, or get help with companyFILES tools.
