...
Alle Endpunkte erfordern eine Authentifizierung über einen [API-Schlüssel](/de/company-gpt/addons/companyrag/#api-schl%C3%BCssel-nur-f%C3%BCr-administratoren). Der Schlüssel wird im `Authorization`-Header als Bearer Token übermittelt:
