...
description: Design discount rules, approval matrices, and exception flows — the governance foundation for Deal Desk and sales teams. Includes discount matrix design, lint checks, and audit trail.
---

Use this skill when creating a company's first formal commercial policy, revising an outdated matrix, enforcing approval rules for exceptions, or when the CFO has tightened the margin floor.
