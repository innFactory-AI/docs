...
description: Orchestrates all commercial sub-skills — pricing, deal desk, partnerships, channel economics, commercial policy, RFP response, and bookings forecast — in a single entry point.
---

Use this skill for reviewing, approving, or designing commercial processes: pricing models, deal evaluation, discount approval, partner economics, channel economics, commercial policy, RFP responses, and bookings forecasts.
