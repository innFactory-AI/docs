...
- **Company colors:** If you have set company colors in [Settings](#settings), they are automatically applied to all newly created charts – bars, lines and areas adapt accordingly.
