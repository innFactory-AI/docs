...
All charts and diagrams created in the chat are collected here. Use the **"All Items"** filter to filter by chart type (e.g. Bar, Line, Pie). Each card shows the title, a preview, the type, and the creation date.
