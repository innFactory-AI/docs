...
In dieser Anleitung richten wir einen **Hilfe-Agenten** ein, der Fragen zu einer Dokumentationswebsite beantwortet. Dazu lassen wir die [Webcrawl-Quelle](/de/company-gpt/addons/companyrag/quellen/#web-crawl) von [CompanyRAG](/de/company-gpt/addons/companyrag/) die Sitemap der Website regelmäßig crawlen, alle Seiten in einer Sammlung indexieren und stellen diese anschließend über den MCP Server `ai-search` einem [Agenten](/de/company-gpt/agenten/) zur Verfügung.
