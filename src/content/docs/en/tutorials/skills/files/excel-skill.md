---
title: Excel Skill
description: Create, read, and modify Excel spreadsheets with companyFILES MCP tools.
---

Use this skill when asked to create, edit, or read Excel files, apply formulas, or work with multi-sheet workbooks.
