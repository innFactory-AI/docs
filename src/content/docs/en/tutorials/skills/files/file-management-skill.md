...
description: Upload, download, list, search, and manage files with companyFILES MCP tools.
---

Use this skill when asked to upload or find files, get download links, create ZIP archives, or save text and code files.
