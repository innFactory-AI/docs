...
**Limitierung**: Die Dokumente sind nur für den jeweiligen User zugänglich. Um Dokumente in der Dateisuche für mehrere User oder die gesamte Organisation zugänglich zu machen, können diese über [Agenten](/company-gpt/agenten) oder auch über die [KI Suche](de/company-gpt/addons/ki-suche) integriert werden.
