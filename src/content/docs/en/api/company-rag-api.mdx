...
All endpoints require authentication via an [API key](/en/company-gpt/addons/companyrag/api-schluessel/). The key is sent in the `Authorization` header as a Bearer token:
