---
title: Overview
description: Discover common prompt techniques for LLMs and agents in CompanyGPT to improve their output and achieve desired results. Learn how combining techniques can boost performance.
---

The following section provides an overview of various common prompt techniques. These can significantly influence the output of LLMs and agents in CompanyGPT and lead to the desired result.

The prompt techniques presented here can all be implemented very well in CompanyGPT. It is very important to note that these prompt techniques are not **either/or**, but rather **interdependent**. Powerful AI applications and agents always use a combination (often) of all the techniques presented here.
