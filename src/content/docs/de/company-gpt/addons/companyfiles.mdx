...
Alle im Chat erstellten Visualisierungen werden hier gesammelt angezeigt. Über den Filter **„Alle Elemente"** können Sie nach Diagrammtyp filtern (z. B. Diagramme oder Charts). Jede Karte zeigt den Titel, eine Vorschau, den Typ und das Erstellungsdatum.
...
- **Company-Farben:** Haben Sie in den [Einstellungen](#einstellungen) Unternehmensfarben hinterlegt, werden diese automatisch auf alle neu erstellten Charts angewendet – Balken, Linien und Flächen passen sich entsprechend an.
